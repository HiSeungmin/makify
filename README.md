...
|:----------------------------------------------:|:-----------------------------------------------------------------:|
| <img src="docs/images/챌린지목록.png" width="400"/> |         <img src="docs/images/검색어자동완성.png" width="400"/>          |
|               사용자 화면 #3 - 챌린지 상세               |                       사용자 화면 #4 - 외부 결제 API                       |
| <img src="docs/images/챌린지상세.png" width="400"/> |          <img src="docs/images/결제API.png" width="400"/>           |
|               사용자 화면 #5 - 마이페이지                |                         사용자 화면 #6 - 인증하기                          |
| <img src="docs/images/마이페이지.png" width="400"/> |           <img src="docs/images/인증하기.png" width="400"/>           |
|              사용자 화면 #7 - 내 인증 내역               |                      사용자 화면 #8 - 다른 사람 인증 내역                      |
| <img src="docs/images/내인증내역.JPG" width="400"/> |         <img src="docs/images/다른사람인증내역.JPG" width="400"/>         |
